...
export const metadata: Metadata = {
  ...
  description:
    "Бетон, песок, щебень, чернозём, аренда самосвалов и кранов с доставкой по Духанино и Истринскому району. Звоните: +7 925 020-15-26",
  keywords:
  ...
  openGraph: {
    ...
    description:
      "Песок, щебень, бетон, чернозем и техника — с доставкой по Истре. +7 925 020-15-26",
